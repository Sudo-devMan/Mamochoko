...
function MomentDetailPublic() {
  ...
  return (
    !loading && moment !== null ? <>
                                        ...
                                        <div  className="row">
                                                    ...
                                                    moment.media.map((media, i) => {
                                                        if (media.media_type === 'image') {
                                                            return <div key={i} className="d-inline-block align-top m-1 border shadow">
                                                                        ...
                                                                        <br/>
                                                                        { user && user.id === moment.id && <button onClick={() => deleteMomentMedia(media.id)} className="btn btn-default m-1"><i className="fas fa-trash text-danger"></i></button> }
                                                                    </div>
                                                        } else {
                                                            return <div key={i} className="d-inline-block align-top m-1 border shadow">
                                                                        ...
                                                                        { user && user.id === moment.user.id && <button onClick={() => deleteMomentMedia(media.id)} className="btn btn-default m-1"><i className="fas fa-trash text-danger"></i></button> }
                                                                    </div>
                                                        }
                                                    })
                                                }
                                            ...
                                            <div className="col-lg-4">
                                                <div className="container">
                                                    ...
                                                    <hr />
                                                    {
                                                        user && moment.user.id === user.id ? <div className="card-footer">
                                                                                    ...
                                                                                    :  <div className="card-footer">
                                                                                        <Link onClick={() => history.back()} className="card-link btn btn-secondary me-2">
                                                                                            <i className="fas fa-arrow-left me-2"></i>
                                                                                        </Link>
                                                                                    </div>
                                                    }
                            ...
                            :  <h1 className="text-center text-muted display-3 m-3">LOADING... <br /><br /><br /><br /><br /><br /><br /><br /><br /><br /></h1>
  )
}

export default MomentDetailPublic;