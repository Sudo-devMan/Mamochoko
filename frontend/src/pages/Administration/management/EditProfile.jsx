...
function EditProfile() {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            ...
            if (res.status === 200) {
                ...
                navigate(`/admin/users/${localUser.id}/detail`)
            }
        } catch (err) {
  ...
  return (
    !loading && user !== null && user.id === localUser.id ? <>
                            ...
                            :  user !== null && user.id !== localUser.id ? <h1 className="text-center text-muted display-3 m-3">BRUH 💀..</h1> : <h1 className="text-center text-muted display-3 m-3">LOADING...</h1>
  )
}
